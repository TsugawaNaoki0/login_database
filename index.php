...
if (isset($_SESSION['EMAIL'])) {
  ...
  echo '<br>';
  echo '<br>';
  echo "<a href='./organized_homepage/index.html'>ホームページ</a>";
  echo '<br>';
  echo '<br>';
  echo "<a href='http://35.81.113.142/' target='_blank'>Pleasanter</a>";
  echo '<br>';
  echo '<br>';
  echo "<a href='./news.php'>ニュース</a>";
  echo '<br>';
  echo '<br>';
  echo "<a href='https://www.netflix.com/browse' target='_blank'>NETFLIX</a>";
  echo '<br>';
  echo '<br>';
  // echo "<a href='https://www.oshimaland.co.jp/' target='_blank'>大島てる</a>";
  echo '<br>';
  echo '<br>';
